...
flags.DEFINE_string('root_dir', './output_urban_planning_ga/', 'Root directory for writing '
...
flags.DEFINE_integer('global_seed', 111, 'Used in env and weight initialization, does not impact action sampling.')
